...
export default function Home() {
  ...
  return <main className="min-h-screen px-4 py-5 sm:px-8 sm:py-8 lg:px-12"><div className="mx-auto max-w-7xl"><header className="flex flex-col gap-6 border-b border-[var(--line)] pb-7 sm:flex-row sm:items-center sm:justify-between">
    <div className="flex items-center gap-3">
      <div className="grid size-10 place-items-center rounded-xl bg-[var(--brand)] font-serif text-xl text-white shadow-sm">S</div>
      <div>
        <p className="text-lg font-semibold tracking-tight text-[var(--ink)]">Schedula</p>
        <p className="text-sm text-[var(--muted)]">Clinic operations</p>
      </div>
    </div>
    <div className="flex items-center gap-3">
      <button
        className="rounded-lg border border-[var(--line)] px-4 py-2.5 text-sm font-semibold text-[var(--ink)] hover:bg-stone-50 transition"
        type="button"
      ...
      <button
        className="rounded-lg bg-[var(--brand)] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[var(--brand-deep)] transition"
        type="button"
